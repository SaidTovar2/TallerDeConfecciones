...
public class Ventas {
    ...
    public Ventas(int maes_esta_conf, String descripcion, String fecha_llegada, String fecha_salida, String maes_tico, String maes_tite, String empl_id, int clie_id) {
    ...
    public String getMaes_tico() {
        return maes_tico;
    }

    public void setMaes_tico(String maes_tico) {
        this.maes_tico = maes_tico;
    }

    public String getMaes_tite() {
        return maes_tite;
    }

    public void setMaes_tite(String maes_tite) {
        this.maes_tite = maes_tite;
    }
